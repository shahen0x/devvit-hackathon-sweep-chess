...
if (sprite_index != -1)
{
    ...
    // Draw 144x144 sprite stretched to fit global.cell_size
    draw_sprite_stretched(sprite_index, image_index, px, py, global.cell_size, global.cell_size);
...
else
{
    ...
    draw_circle(px + global.cell_size / 2, py + global.cell_size / 2, global.cell_size / 3, false);
