...
if (!is_moving && mouse_check_button_pressed(mb_left))
{
    ...
    if (point_in_rectangle(mouse_x, mouse_y, knight_px, knight_py, knight_px + CELL_SIZE, knight_py + CELL_SIZE))
    {
        ...
        with (oKnight) { if (id != other.id) { is_selected = false; valid_moves = []; } }
    }
